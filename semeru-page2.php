        ...
        <div class="content-container">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    <a href="semeru-page1.php?slug=<?php echo $slug; ?>" title="Kembali ke Halaman 1">
                        <i class="fa-solid fa-arrow-left"></i>
                    </a>

                    <a href="semeru-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a class="active" href="semeru-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
