...
$slug = isset($_GET['slug']) ? mysqli_real_escape_string($conn, $_GET['slug']) : 'gunung-semeru';
...
<head>
    ...
    <link rel="stylesheet" href="css/semeru-page.css">
        ...
        <div class="content-container">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    ...
                    <a class="active" href="semeru-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a href="semeru-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
