        ...
        <div class="content-container">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    <a href="salak-page1.php?slug=<?php echo $slug; ?>" title="Kembali ke Halaman 1">
                        <i class="fa-solid fa-arrow-left"></i>
                    </a>

                    <a href="salak-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a class="active" href="salak-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
