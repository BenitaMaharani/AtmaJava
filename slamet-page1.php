...
$slug = isset($_GET['slug']) ? mysqli_real_escape_string($conn, $_GET['slug']) : 'gunung-slamet';
...
<head>
    ...
    <link rel="stylesheet" href="css/slamet-page.css">
    ...
    <div class="main-card">
        ...
        <div class="content-container">
            ...
            <div class="article-body">
                <?php echo $data['deskripsi_page1']; ?>
            </div>
            
            <div class="pagination-wrapper">
                <div class="pagination">
                    <a href="index.php" title="Kembali ke Jelajah">
                        <i class="fa-solid fa-compass"></i>
                    </a>

                    <a class="active" href="slamet-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a href="slamet-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
