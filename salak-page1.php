...
$slug = isset($_GET['slug']) ? mysqli_real_escape_string($conn, $_GET['slug']) : 'gunung-salak';
...
<head>
    ...
    <link rel="stylesheet" href="css/salak-page.css">
        ...
        <div class="content-container">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    ...
                    <a class="active" href="salak-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a href="salak-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
