...
$slug = isset($_GET['slug']) ? mysqli_real_escape_string($conn, $_GET['slug']) : 'gunung-sumbing';
        ...
        <div class="content-container">
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    <a href="sumbing-page1.php?slug=<?php echo $slug; ?>" title="Kembali ke Halaman 1">
                        <i class="fa-solid fa-arrow-left"></i>
                    </a>

                    <a href="sumbing-page1.php?slug=<?php echo $slug; ?>">
                        1
                    </a>

                    <a class="active" href="sumbing-page2.php?slug=<?php echo $slug; ?>">
                        2
                    </a>
                </div>
            </div>
